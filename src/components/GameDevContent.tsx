  ...
  return (
    <div className='font-Lexend'>
      <div className="flex-col mt-20 container mx-auto px-10">
        <h1 className="inline-flex bg-fallColor2 text-fallColor4 text-lg p-3  rounded-full text-[32px] decoration-2 font-Lexend font-bold mb-5">
        ...
        <p className="text-[25px] decoration-2 text-white font-Lexend font-normal text-justify drop-shadow-lg">
          <span className="font-bold text-fallColor4">Game Development Competition</span> merupakan lomba pengembangan alat (hardware) merupakan lomba pembuatan game yang diadakan untuk siswa/i SMA/SMK/sederajat dan mahasiswa dalam mengembangkan ide,
      ...
      <hr className="h-[5px] mx-auto my-4 md:my-10 bg-fallColor3 border-0" />

      <div className="flex-col mt-20 container mx-auto px-10">
        <h1 className="inline-flex bg-fallColor2 text-fallColor4 text-lg rounded-full p-3 text-[32px] decoration-2 font-Lexend font-bold mb-5">
      ...
      <div className="flex-col mt-20 container mx-auto px-10">
        ...
        <section>
          <div className="border-l-4 border-fallColor3 ml-3 mt-3 py-16 space-y-14 font-Lexend">
            <div className="relative">
              <div className="top-5 -left-3.5 border-white bg-fallColor4 h-6 w-6 rounded-full border-4"></div>
              <div className="pl-10">
                <span className="text-sm text-white font-bold tracking-widest drop-shadow-lg">
                  June 1<sup>st</sup>, 2023
                </span>
                <h3 className="text-3xl font-bold tracking-wide text-fallColor4 mb-2">Registration</h3>
            ...
            <div className="relative">
              ...
              <div className="pl-10">
                ...
                <h3 className="text-3xl text-fallColor4 font-bold tracking-wide mb-2">Announcement</h3>
      ...
      <hr className="h-[5px] mx-auto my-2 md:my-10 bg-fallColor3 border-0" />
      ...
      <div className="flex-col mt-20 pb-20 container text-white mx-auto px-10">
        ...
        <p className="text-md sm:text-lg decoration-2 font-Lexend font-normal text-justify drop-shadow-lg">
          ...
          <Link href="#" className="text-fallColor4 font-Lexend font-bold hover:text-fallColor2">
            di sini
          </Link>
        </p>
      </div>
