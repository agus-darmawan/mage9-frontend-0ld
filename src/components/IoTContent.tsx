    ...
    <div>
      ...
      <div className="flex-col mt-20 container mx-auto px-10">
        ...
        <p className="text-[25px] decoration-2 font-Lexend font-normal text-justify">
          <span className="font-bold">Internet of Things Development Competition</span> merupakan lomba pengembangan alat (hardware) yang terintegrasi dengan aplikasi (software) yang memanfaatkan koneksi nirkabel seperti jaringan internet.
