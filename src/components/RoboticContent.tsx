  ...
  return (
    <div>
      <div className="flex-col mt-28 flex items-center justify-center">
        <h1 className="text-center font-bold  text-xl sm:text-4xl  leading-tight">Robotik Pic Here</h1>
      </div>
      ...
      <div className="flex-col mt-20 container mx-auto px-10">
        ...
        <p className="text-[25px] decoration-2 font-Lexend font-normal text-justify">
          <span className="font-bold">Robotic Competition</span> merupakan lomba pengoperasian robot yang diadakan untuk siswa/i SD dan SMP. Pada tahun ini MAGE 9 berfokus pada kompetisi line tracer dimana robot akan dibuat untuk bergerak
          mengikuti garis pandu yang telah disediakan.
        </p>
      </div>
      ...
      <div className="flex-col container mx-auto px-10">
        <div>
          ...
          <p className="text-md sm:text-lg decoration-2 font-Lexend font-normal text-justify">
            0895 6379 62798 - <span className="font-bold">Zafa</span>
            <br />
