        ...
        <ul className="items-center sm:flex">
            <li className="relative mb-6 sm:mb-0">
                ...
                <div className="mt-3 sm:pr-8">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Grand Opening</h3>
                    <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Juma'at, 19 Mei 2023</time>
            ...
            <li className="relative mb-6 sm:mb-0">
                ...
                <div className="mt-3 sm:pr-8">
                    ...
                    <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Juma'at, 20 Agustus 2023</time>
            ...
            <li className="relative mb-6 sm:mb-0">
                ...
                <div className="mt-3 sm:pr-8">
                    ...
                    <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">uma'at, 20 Agustus 2023</time>
                    <p className="text-base font-normal text-gray-500 dark:text-gray-400">Get started with dozens of web components and interactive elements.</p>
                </div>
            </li>
        </ul>
